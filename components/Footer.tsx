...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-secondary-bg text-center py-10 border-t border-highlight-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xs text-slate-500 mt-2">
          Learn Digital Marketing in Bangladesh | Built with Passion
        </p>
      </div>
    </footer>
  );
